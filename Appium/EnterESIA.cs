...
namespace AppiumTest
{
    ...
    public class EnterESIA
    {
        ...
        public void Setup()
        {
            //var driverOption = new DesiredCapabilities();
            ...
            //driverOption.AddAdditionalCapability("automationName", "UiAutomator1");
            driverOption.AddAdditionalCapability("platformName", "Android");
            driverOption.AddAdditionalCapability("platformVersion", "11.0");
            driverOption.AddAdditionalCapability("deviceName", "Pixel 2");
            //driverOption.AddAdditionalCapability("appPackage", "ru.msp.rf.app");
            _driver = new AndroidDriver<AndroidElement>(new Uri("http://localhost:4723/wd/hub"), driverOption);    
